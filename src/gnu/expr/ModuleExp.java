...
_L4:
        ...
        environment = classloader;
        url1 = url;
        classloader = url.getContextClassLoader();
        compilation = classloader;
        environment = classloader;
        url1 = url;
        url.setContextClassLoader(class1.getClassLoader());
        compilation = classloader;
_L10:
        environment = compilation;
        url1 = url;
...
_L8:
        ...
        if (url != null)
        {
            url.setContextClassLoader(compilation);
            return outport;
        }
          goto _L5
        environment;
...
_L9:
        ...
        Compilation.restoreCurrent(compilation1);
        environment = class1;
        if (url == null) goto _L5; else goto _L11
_L11:
        url.setContextClassLoader(compilation);
        return class1;
        compilation;
        ...
        if (url1 != null)
        {
            url1.setContextClassLoader(environment);
        }
        throw compilation;
    }
