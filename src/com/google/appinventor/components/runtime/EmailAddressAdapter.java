...
public class EmailAddressAdapter extends ResourceCursorAdapter
{
    ...
    public EmailAddressAdapter(Context context1)
    {
        ...
        {
            SORT_ORDER = (new StringBuilder()).append(HoneycombMR1Util.getTimesContacted()).append(" DESC, ").append(HoneycombMR1Util.getDisplayName()).toString();
            return;
        } else
        {
    ...
    {
        int i = cursor.getColumnIndex(HoneycombMR1Util.getDisplayName());
        int j = cursor.getColumnIndex(HoneycombMR1Util.getEmailAddress());
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charsequence)
    {
        ...
        if (charsequence != null)
        {
            ...
            if (SdkLevel.getLevel() >= 12)
            {
                ...
                stringbuilder.append((new StringBuilder()).append("(").append(HoneycombMR1Util.getDataMimeType()).append("='").append(HoneycombMR1Util.getEmailType()).append("')").toString());
