...
label0:
    ...
    public String postHoneycombGetContactNameAndPicture(Cursor cursor)
    {
        ...
        if (cursor.moveToFirst())
        {
            int i = HoneycombMR1Util.getContactIdIndex(cursor);
            int j = HoneycombMR1Util.getNameIndex(cursor);
            int k = HoneycombMR1Util.getThumbnailIndex(cursor);
            phoneNumber = guardCursorGetString(cursor, HoneycombMR1Util.getPhoneIndex(cursor));
...
_L5:
        ...
        intent = cursor1;
        obj = obj3;
        obj2 = HoneycombMR1Util.getDataCursor(s, activityContext, DATA_PROJECTION);
        cursor = cursor1;
        obj1 = obj2;
        intent = cursor1;
        obj = obj2;
