...
public class TimePicker extends ButtonBase
{
    ...
    public TimePicker(ComponentContainer componentcontainer)
    {
        ...
        time = new TimePickerDialog(container.$context(), timePickerListener, hour, minute, DateFormat.is24HourFormat(container.$context()));
        instant = Dates.TimeInstant(hour, minute);
    ...
    {
        int i = Dates.Hour(calendar);
        int j = Dates.Minute(calendar);
        time.updateTime(i, j);
...
/*
    static Calendar access$202(TimePicker timepicker, Calendar calendar)
    {
