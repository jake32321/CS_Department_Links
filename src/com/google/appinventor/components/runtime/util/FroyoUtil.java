...
_L1:
                return;
_L2:
                if (player != null && player.playerState == com.google.appinventor.components.runtime.Player.State.PLAYING)
                {
                    player.pause();
                    playbackFlag = true;
                    return;
...
_L3:
                ...
                return;
_L4:
                if (player != null && playbackFlag && player.playerState == com.google.appinventor.components.runtime.Player.State.PAUSED_BY_EVENT)
                {
                    player.Start();
                    playbackFlag = false;
                    return;
