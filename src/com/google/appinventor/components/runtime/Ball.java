...
//            Sprite, Form, ComponentContainer
...
public final class Ball extends Sprite
{
    ...
    protected void onDraw(Canvas canvas)
    {
        if (visible)
        {
            float f = (float)(xLeft * (double)form.deviceDensity());
            float f1 = (float)(yTop * (double)form.deviceDensity());
            float f2 = (float)radius * form.deviceDensity();
            canvas.drawCircle(f + f2, f1 + f2, f2, paint);
        }
    }
}
